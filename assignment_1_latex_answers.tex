...
The only distribution that might apply is the delta function at zero, this will remain zero as the recurrence relation is

$Z_{n+1} = Z_nexp(X_{n+1})$

There may be some argument over whether 0 is in the state space of $Z_n$, as it would require $X_n = -\infty$.
